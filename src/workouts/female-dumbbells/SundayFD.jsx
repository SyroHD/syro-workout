    ...
    <Fragment>
      ...
      <div className={styles["videos-container"]}>
        <div className={styles.card}>
          ...
          <h3 className={styles["video-title"]}>9 Minute Ab Workout</h3>
        </div>
        <div className={styles.card}>
          <div className={styles["video-container"]}>
            <iframe
          ...
          <h3 className={styles["video-title"]}>
            6 Minute Bodyweight Back Exercises (Mainly Lower Back)
          </h3>
        </div>
        <div className={styles.card}>
          <div className={styles["video-container"]}>
          ...
          <h3 className={styles["video-title"]}>10 Minute Ab Workout</h3>
        </div>
      </div>
    </Fragment>
  );
